...
<asp:Content ID="Content1" ContentPlaceHolderID="login" Runat="Server">
    ...
    rr<table style="width: 100%; height: 435px;">
    <tr>
    ...
    <tr>
        ...
        <td>
            <asp:DropDownList ID="drpSt" runat="server" DataTextField="typename" DataValueField="typename" AutoPostBack="True"  >
    ...
    <tr>
        ...
        <td colspan="2">
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <div><asp:Button ID="btnSea" runat="server" OnClick="btnSea_Click" Text="search" /></div>
        </td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
    </tr>
    ...
    <tr>
        <td style="height: 32px; width: 233px"></td>
        <td style="height: 32px; width: 175px">&nbsp;</td>
